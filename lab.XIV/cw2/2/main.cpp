//2.	W pliku binarnym zostały zapisane dane o strukturze: nazwisko, adres, stanowisko, brutto
//(dla celów testowych należy wprowadzić dane). Napisz program, który na podstawie tych danych
//utworzy raport i zapisz go do pliku tekstowego. Ma on zawierać informacje: tytuł raportu, data raportu,
//kto sporządził,  dane z pliku binarnego, podsumowanie i średnia dla wybranego stanowiska.
